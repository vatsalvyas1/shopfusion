    ...
    useEffect(() => {
        ...
        if (loggedUser) {
            setUser({
                ...
                date: new Date().toLocaleDateString(), // Or however you store the date
                role: 'Admin', // Replace with actual role if applicable
                uid: loggedUser.uid
            });
        }
    }, [auth]);
                    ...
                    <div className="mid mb-5">
                        ...
                        <div className="bg-blue-50 py-5 rounded-xl border border-blue-100">
                            ...
                            <div className="flex justify-center">
                                <img src={user.photoURL || "https://cdn-icons-png.flaticon.com/128/2202/2202112.png"} alt="Profile" className="rounded-full w-32 h-32"/>
                            </div>
                            {/* text */}
                            <div className="">
                                {/* Name */}
